(function(Blotter) {
  ...
  (function(Blotter) {
    ...
    Blotter.ChannelLiquidMaterial = function() {
      Blotter.Material.apply(this, arguments);
    };
  
    Blotter.ChannelLiquidMaterial.prototype = Object.create(Blotter.Material.prototype);
  
    Blotter._extendWithGettersSetters(Blotter.ChannelLiquidMaterial.prototype, (function () {
      ...
      return {
        ...
        constructor : Blotter.ChannelLiquidMaterial,
        ...
        init : function () {
          ...
          this.uniforms = {
            ...
            uRotation : { type : "1f", value : 45.0 },
            uApplyBlur : { type : "1f", value : 1.0 },
            //uBlendColor : { type: "4f", value : [0,0,0.0,0.0]},
            uAnimateNoise : { type : "1f", value : 1.0 },
            uSpeed : { type : "1f", value : 1.0 },
            uVolatility : { type : "1f", value : 0.15 },
            uSeed : { type : "1f", value : 0.1 }
